...
function ForgetPassword() {
  ...
  return (
    <>
      <Navbar />
      <div className='bg-white mt-12 w-full px-6 flex flex-col items-center justify-center'>
        <div className="form-box w-[450px] shadow-xl rounded-md flex gap-5 flex-col items-center mt-10 px-4 py-4">
          {
            emailMessage ? null :
