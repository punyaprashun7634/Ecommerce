...
const Login = () => {
    ...
    return (
        <>
            <Navbar />
            <div className='bg-white w-full px-6 flex flex-col items-center mt-8 justify-center'>
                <div className="form-box w-[450px] shadow-xl rounded-md flex gap-5 flex-col items-center px-4 py-4" id="login">
